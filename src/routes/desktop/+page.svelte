<script>
    ...
    const updateSummary = () => {
        onlineCount = currentData.filter(item => getEmojiByLastUpdated(item.updatedAt) === "🍏").length;
    ...
    onMount(() => {
        fetchBotData();
        setInterval(fetchBotData, 10000); // Update every minute
    });
</script>
    ...
    <div class="grid grid-cols-2 gap-4 mb-8 sm:grid-cols-4 md:grid-cols-8">
        <div class="bg-[#1c306e] p-6 rounded-xl">
            <p class="text-2xl font-bold flex items-center">
                ...
                <span class="text-blue-400 mr-2 px-3" id="last-updated-serven">{summary.serven}</span>
            </p>
        </div>
        <div class="bg-[#1c306e] p-6 rounded-xl">
            <p class="text-2xl font-bold flex items-center">
                <img class="w-12" src="https://cdn-offer-photos.zeusx.com/3b7e36ed-53ea-4049-84e1-a0200e07d1e5.jpg" alt="" srcset="">
                <span class="text-blue-400 mr-2 px-3" id="last-updated-god">{summary.god}</span>
            </p>
        </div>
        <div class="bg-[#1c306e] p-6 rounded-xl">
            <p class="text-2xl font-bold flex items-center">
                <img class="w-12" src="/cdk.webp" alt="" srcset="">
                <span class="text-blue-400 mr-2 px-3" id="last-updated-cdk">{summary.cdk}</span>
            </p>
        </div>
        <div class="bg-[#1c306e] p-6 rounded-xl">
            <p class="text-2xl font-bold flex items-center">
                <img class="w-12" src="/Shark.webp" alt="" srcset="">
                <span class="text-blue-400 mr-2 px-3" id="last-updated-sa">{summary.sa}</span>
            </p>
        </div>
        <div class="bg-[#1c306e] p-6 rounded-xl">
            <p class="text-2xl font-bold flex items-center">
                <img class="w-12" src="/mirror.webp" alt="" srcset="">
                <span class="text-blue-400 mr-2 px-3" id="last-updated-mirror">{summary.mirror}</span>
            </p>
        </div>
        <div class="bg-[#1c306e] p-6 rounded-xl">
            <p class="text-2xl font-bold flex items-center">
                <img class="w-12" src="/valkyrie.webp" alt="" srcset="">
                <span class="text-blue-400 mr-2 px-3" id="last-updated-valkyrie">{summary.valkyrie}</span>
            </p>
        </div>
        <div class="bg-[#1c306e] p-6 rounded-xl">
            <p class="text-2xl font-bold flex items-center">
                <img class="w-12" src="/door.webp" alt="" srcset="">
                <span class="text-blue-400 mr-2 px-3" id="last-updated-door">{summary.door}</span>
            </p>
        </div>
        <div class="bg-[#1c306e] p-6 rounded-xl">
            <p class="text-2xl font-bold flex items-center">
                <img class="w-12" src="/heart.webp" alt="" srcset="">
                <span class="text-blue-400 mr-2 px-3" id="last-updated-heart">{summary.heart}</span>
            </p>
        </div>
        <div class="bg-[#1c306e] p-6 rounded-xl">
            <p class="text-2xl font-bold flex items-center">
                <img class="w-12" src="/sg.webp" alt="" srcset="">
                <span class="text-blue-400 mr-2 px-3" id="last-updated-sg">{summary.sg}</span>
            </p>
        </div>
        <div class="bg-[#1c306e] p-6 rounded-xl">
            <p class="text-2xl font-bold flex items-center">
                <img class="w-12" src="/moji.webp" alt="" srcset="">
                <span class="text-blue-400 mr-2 px-3" id="last-updated-moji">{summary.moji}</span>
            </p>
        </div>
        <div class="bg-[#1c306e] p-6 rounded-xl">
            <p class="text-2xl font-bold flex items-center">
                <img class="w-12" src="/dragon.webp" alt="" srcset="">
                <span class="text-blue-400 mr-2 px-3" id="last-updated-dragon">{summary.dragon}</span>
            </p>
        </div>
        <div class="bg-[#1c306e] p-6 rounded-xl">
            <p class="text-2xl font-bold flex items-center">
                <img class="w-12" src="/mammoz.webp" alt="" srcset="">
                <span class="text-blue-400 mr-2 px-3" id="last-updated-mammoz">{summary.mammoz}</span>
            </p>
        </div>
        <div class="bg-[#1c306e] p-6 rounded-xl">
            <p class="text-2xl font-bold flex items-center">
                <img class="w-12" src="/kiserni.webp" alt="" srcset="">
                <span class="text-blue-400 mr-2 px-3" id="last-updated-kiserni">{summary.kiserni}</span>
            </p>
        </div>
        <div class="bg-[#1c306e] p-6 rounded-xl">
            <p class="text-2xl font-bold flex items-center">
                <img class="w-12" src="/tiger.webp" alt="" srcset="">
                <span class="text-blue-400 mr-2 px-3" id="last-updated-tiger">{summary.tiger}</span>
            </p>
        </div>
        <div class="bg-[#1c306e] p-6 rounded-xl">
            <p class="text-2xl font-bold flex items-center">
                <img class="w-12" src="/yeti.webp" alt="" srcset="">
                <span class="text-blue-400 mr-2 px-3" id="last-updated-yeti">{summary.yeti}</span>
            </p>
        </div>
        <div class="bg-[#1c306e] p-6 rounded-xl">
            <p class="text-2xl font-bold flex items-center">
                <img class="w-12" src="/gas.webp" alt="" srcset="">
                <span class="text-blue-400 mr-2 px-3" id="last-updated-gas">{summary.gas}</span>
            </p>
        </div>
    </div>
    ...
    <div class="p-6">
        <div class="flex justify-end items-center">
            <span class="isolate inline-flex rounded-md shadow-sm">
                ...
                <button type="button" class="relative -ml-px inline-flex items-center text-white bg-indigo-600 px-3 py-2 text-sm font-semibold ring-1 ring-inset ring-indigo-300 focus-visible:outline hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">📄Sheet</button>
                <button type="button" on:click={getscript} class="relative -ml-px inline-flex items-center rounded-r-md text-white bg-indigo-600 px-3 py-2 text-sm font-semibold ring-1 ring-inset ring-indigo-300 focus-visible:outline hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">🎮Script</button>
              </span>
        </div>
    </div>
